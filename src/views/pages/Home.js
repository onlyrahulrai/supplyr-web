...
const StatsSmallCard = (props) => {
  ...
  return (
    <Card>
      <CardBody className="stats-card-body d-flex justify-content-between flex-row-reverse align-items-center">
        <div className="icon-section">
          <div
            className={`avatar avatar-stats p-50 m-0 bg-rgba-${
              color ?? "primary"
            }`}
          >
...
const Dashboard = () => {
  ...
  return (
    <>
      ...
      {!isLoading && (
        <>
          {loadingError && <NetworkError error={loadingError} />}
                  ...
                  <Row>
                    ...
                    <Col>
                      <StatsSmallCard
                        ...
                        color="primary"
                        icon={
                          <RiUserReceived2Line className="primary" size={22} />
                        }
                      />
                    </Col>
                  </Row>
