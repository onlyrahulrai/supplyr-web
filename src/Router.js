...
const ProductsList = lazy(() => import("./views/inventory/ProductsList"));
const AddProduct = lazy(() => import("./views/inventory/AddProduct"));
const ImportProduct = lazy(() => import("./views/import-export/ImportProduct"));
const ExportProduct = lazy(() => import("./views/import-export/ExportProduct"));
const ProductDetails = lazy(() => import("./views/listing/ProductDetails"));

const CategoryList = lazy(() => import("./views/inventory/CategoryList"));

const CategoryAdd = lazy(() => import("./views/inventory/CategoryAdd"));

const login = lazy(() => import("./views/pages/authentication/Login"));

const register = lazy(() => import("views/pages/authentication/Register"));

const ProfilingWizard = lazy(() => import("views/pages/ProfilingWizard"));

const OrdersList = lazy(() => import("views/orders/OrdersList"));
...
const BuyerDiscounts = lazy(() =>
  import("views/buyer-discounts/BuyerDiscounts")
);

const Salespersons = lazy(() => import("./views/management/Salespersons"));
...
const ConfirmEmail = lazy(() =>
  import("./views/pages/authentication/ConfirmEmail")
);
const PasswordReset = lazy(() =>
  import("./views/pages/authentication/PasswordReset")
);
const PasswordResetRequest = lazy(() =>
  import("./views/pages/authentication/PasswordResetRequest")
);
...
const RouteConfig = ({
  ...
  <Route
    ...
    render={(props) => {
      ...
      if (publicOnlyUrl) {
        return authenticated ? authenticatedUserRedirect : actualContent;
      }
      ...
      if (authenticated) {
        if (user.user_status === "approved") {
          ...
          props.location.pathname === "/profiling" ||
...
const PublicRouteConfig = ({ ...rest }) => (
  <RouteConfig {...rest} publicUrl={true} />
);

const PublicOnlyRouteConfig = ({ ...rest }) => (
  <RouteConfig {...rest} publicOnlyUrl={true} />
);
    ...
    return (
      ...
      <Router history={history}>
        <Switch>
          ...
          <AppRoute exact path="/inventory" component={Products} />
          <AppRoute exact path="/products/" component={ProductsList} />
          <AppRoute exact path="/product/:slug/" component={ProductDetails} />
